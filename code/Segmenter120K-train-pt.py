...
fulltrainset = torchvision.datasets.ImageFolder(
    root='../data/CROHMES+junk', transform=transform)
...
segmenter120k, loss = train_cnn(net120k, lr=1e-3, epoch=1)

model_scripted = torch.jit.script(segmenter120k)
model_scripted.save('../model/segmenter_120K.pt')
